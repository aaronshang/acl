...
ACL_EVENT *event_new_kernel3(int fdsize acl_unused)
{
	ACL_EVENT *eventp;
	EVENT_KERNEL *ev;
	...
	eventp->event_mode           = ACL_EVENT_KERNEL3;
	eventp->use_thread           = 0;
