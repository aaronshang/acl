...
acl_int64 acl_aio_request_timer(ACL_AIO *aio, ACL_AIO_TIMER_FN timer_fn,
...
acl_int64 acl_aio_cancel_timer(ACL_AIO *aio, ACL_AIO_TIMER_FN timer_fn, void *context)
{
...
void acl_aio_keep_timer(ACL_AIO *aio, ACL_AIO_TIMER_FN callback,
...
int acl_aio_timer_ifkeep(ACL_AIO *aio, ACL_AIO_TIMER_FN callback, void *context)
{
