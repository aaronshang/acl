...
extern int acl_master_notify(int, unsigned, int);	/* encapsulate status msg */
...
extern ACL_VSTREAM *ACL_MASTER_FLOW_READ_STREAM;

#define ACL_MASTER_FLOW_WRITE	4
extern ACL_VSTREAM *ACL_MASTER_FLOW_WRITE_STREAM;
...
extern ACL_VSTREAM *ACL_MASTER_STAT_STREAM;

#define ACL_MASTER_LISTEN_FD	6	/* accept connections here */
extern ACL_VSTREAM *ACL_MASTER_LISTEN_STREAM;
